...
copyright = '2019 - 2023 TrustedFirmware.org'
...
man_pages = [
    (master_doc, 'ibart', 'OP-TEE Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'OP-TEE', 'OP-TEE Documentation',
     author, 'OP-TEE', 'One line description of project.',
     'Miscellaneous'),
]
